...
Much more details about this are presented in their [final report](https://ee.cooper.edu/~keene/assets/Charity_Navigator_Final_Paper.pdf). For an interactive data visualization that shows the document clustering, have a look [here](https://yucy96.github.io/Charity_Navi/).
