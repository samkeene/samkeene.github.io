...
---
My Master's student, Joseph Colonel, recently presented a paper [Autoencoding Neural Networks as Musical Audio Synthesizers]({{ site.url }}/~keene/assets/dafx2018_submission42_revised_jcolonel.pdf), at the Digital Audio Effects conference in Averio, Portugal. The purpose of this project is to try to unlock the potential of deep neural networks and create a new type of audio synthesizer.
